...
-- ============================================
-- FACT TABLE: SALES (LINE ITEM GRAIN)
-- ============================================
...
-- ============================================
-- AGGREGATE TABLE: PRODUCT PERFORMANCE
-- ============================================
...
-- ============================================
-- AGGREGATE TABLE: CUSTOMER METRICS
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_fact_sales_payment
    ON warehouse.fact_sales (payment_method_key);
